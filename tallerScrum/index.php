...
<ul class="navbar-nav ms-auto">
  ...
  <li class="nav-item dropdown user-menu">
    ...
    <ul class="dropdown-menu dropdown-menu-end shadow border-0 rounded-3 mt-2" style="min-width: 230px;">
      ...
      <!-- Perfil modal trigger -->
      <li>
        <button type="button" class="dropdown-item btn btn-link text-start" data-bs-toggle="modal" data-bs-target="#perfilModal">
    ...
    <div class="modal-content">
      <form action="./controllers/editar_usuario.php" method="POST">
        <div class="modal-header">
          <h5 class="modal-title" id="perfilModalLabel">Editar Perfil de <?php echo $nombre; ?></h5>
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <select class="form-select" id="rol" name="rol" required>
              ...
              <option value="aprendiz" <?php echo ($rol=="aprendiz") ? "selected" : ""; ?>>Aprendiz</option>
            </select>
          </div>
